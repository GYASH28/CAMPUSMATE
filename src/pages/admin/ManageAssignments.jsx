...
export default function ManageAssignments() {
  ...
  const reset = () => {
    setForm({ ...emptyAssignment, dueDate: addDays(7) });
    setFile(null);
  };
  ...
  const handleSubmit = async (event) => {
    ...
    if (!form.title.trim() || !subject || !form.description.trim() || !form.dueDate) {
      notify('Title, subject, description, and due date are required.', 'error');
      return;
    }
  ...
  return (
    <MotionPage>
      <PageHeader
        ...
        description="Create assignments, attach optional files, and let students mark them completed."
      />
      ...
      <div className="grid gap-5 xl:grid-cols-[0.8fr_1.2fr]">
        ...
        <Card>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <h3 className="text-xl font-black text-white">Assignments list</h3>
            <Input
              className="sm:w-72"
              label="Search"
              icon={Search}
          ...
          {visibleAssignments.length ? (
                  ...
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex shrink-0 gap-2">
                      ...
                      <DeleteButton
                        ...
                        onDelete={() => removeAssignment(assignment)}
                      />
                    </div>
                  </div>
                </div>
            ...
            <EmptyState
              ...
              message="Create assignments for students to track."
            />
          )}
        </Card>
      </div>
